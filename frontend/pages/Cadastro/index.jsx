...
export default function Cadastro() {
  ...
  setSuccessMessage("Conta FaceRec criada com sucesso! Redirecionando para o login...");
      ...
      let message = candidates[0] || 'Erro no cadastro';
      ...
      if (typeof responseData?.code === 'string' && !message.includes(responseData.code)) {
        message = `${message} [${responseData.code}]`;
      }

      console.error("Erro no cadastro:", responseData || err);
